...
@app.route('/text/words', methods = ['GET'])
...
@app.route('/text/ngrams', methods = ['GET'])
...
def return_tweets():
    ...
    for tweet in tweets:
            t.append({'text': tweet.full_text,'profile_pic': tweet.user.profile_image_url,'user_screen_name': tweet.user.screen_name,'created_at': tweet.created_at})    
